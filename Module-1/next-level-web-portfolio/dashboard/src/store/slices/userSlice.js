...
export const getUser = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(`${import.meta.env.VITE_BACKEND_API_URL}/user/me`, {
...
export const logout = () => async (dispatch) => {
  try {
    const { data } = await axios.get(`${import.meta.env.VITE_BACKEND_API_URL}/user/logout`, {
      withCredentials: true,
    });
  ...
  (currentPassword, newPassword, confirmNewPassword) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.put(
        `${import.meta.env.VITE_BACKEND_API_URL}/user/password/update`,
...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `${import.meta.env.VITE_BACKEND_API_URL}/user/me/profile/update`,
      data,
      {
        withCredentials: true,
